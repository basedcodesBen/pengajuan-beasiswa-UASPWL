...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div class="flex flex-col space-y-4">
            <a href="#" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Pengajuan Beasiswa</a>
            <a href="{{ route('admin.users') }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Kelola Pengguna</a>
            <a href="{{ route('fakultas.index') }}" class="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">Kelola Data Fakultas</a>
        </div>
    </div>
</div>