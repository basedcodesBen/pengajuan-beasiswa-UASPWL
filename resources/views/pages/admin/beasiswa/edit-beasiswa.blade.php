...
<div class="min-h-screen flex flex-col items-center">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl mt-10">
        <h2 class="text-2xl font-bold mb-4 text-gray-800">Edit Beasiswa</h2>
        ...
        <form action="{{ route('beasiswa.update', $beasiswa->id_beasiswa) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label for="jenis_beasiswa" class="block text-gray-700">Jenis Beasiswa:</label>
                <input type="text" name="jenis_beasiswa" id="jenis_beasiswa" class="w-full p-2 border border-gray-300 rounded" value="{{ old('jenis_beasiswa', $beasiswa->jenis_beasiswa) }}">
            </div>
            <div>
