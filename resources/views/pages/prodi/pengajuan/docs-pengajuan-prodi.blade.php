        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                @foreach($pengajuan as $document)
                    ...
                    <tr class="border-b">
                        <td class="py-2 px-4">Surat Rekomendasi</td>
                        <td class="py-2 px-4">
                            <a href="{{ asset('storage/' . $document->surat_rekom) }}" target="_blank" class="text-blue-500 hover:underline">View Surat Rekomendasi</a>
                        </td>
                    </tr>
                    <tr class="border-b">
